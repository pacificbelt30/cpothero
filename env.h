...
/* 黒2石 */
//const uint64_t DEBUG_SOLVE_BLACK = 0x100915735111717C;
//const uint64_t DEBUG_SOLVE_WHITE = 0x2596EA8CAEEE0E03;
//const TEBAN DEBUG_SOLVE_TEBAN = SENTE;

/* 黒6石 */
//const uint64_t DEBUG_SOLVE_BLACK = 0x2027F060A122246;
//const uint64_t DEBUG_SOLVE_WHITE = 0x3C3C80F9F5ED5CB8;
//const TEBAN DEBUG_SOLVE_TEBAN = SENTE;

/* 黒4石 */
const uint64_t DEBUG_SOLVE_BLACK = 0xE0404804000D0C;
const uint64_t DEBUG_SOLVE_WHITE = 0xFE1CBFB7FBFF3213;
const TEBAN DEBUG_SOLVE_TEBAN = GOTE;
